...
namespace BigFloatingPoint.FunctionalTests.UsingInstanceMethods
{
    public class WhenConvertingToString
    {
        ...
        [InlineData(-0.00001d, "-0.00001")]
        [InlineData(-0.000001d, "-0.000001")]
        [InlineData(double.MaxValue, Constant.MaxDouble)]
        [InlineData(double.MinValue, Constant.MinDouble)]
        ...
        [InlineData(-0.00001f, "-0.00001")]
        [InlineData(-0.000001f, "-0.000001")]
        [InlineData(float.MaxValue, Constant.MaxFloat)]
        [InlineData(float.MinValue, Constant.MinFloat)]
        ...
        [InlineData(1, "1")]
        [InlineData(-1, "-1")]
        [InlineData(int.MaxValue, Constant.MaxInt)]
        [InlineData(int.MinValue, Constant.MinInt)]
