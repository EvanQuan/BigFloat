...
namespace BigFloatingPoint.FunctionalTests.TestBases
{
    public abstract class PowerToTest
    {
        ...
        [InlineData("1", 1, "1")]
        [InlineData(Constant.MaxDoubleTimes2, 1, Constant.MaxDoubleTimes2)]
        [InlineData(Constant.MaxDouble, 2, Constant.MaxDoubleSquared)]
        [InlineData("1", int.MaxValue, "1")]
        [InlineData("2", 1, "2")]
        [InlineData("2", 2, "4")]
        [InlineData("2", 31, Constant.MaxIntPlus1)]
        ...
        [InlineData("-0.5", 4, "0.0625")]
        [InlineData("-1", 1, "-1")]
        [InlineData(Constant.NegativeMaxDoubleTimes2, 1, Constant.NegativeMaxDoubleTimes2)]
        [InlineData(Constant.NegativeMaxDouble, 2, Constant.MaxDoubleSquared)]
        [InlineData("-1", int.MaxValue, "-1")]
        [InlineData("-2", 1, "-2")]
        [InlineData("-2", 2, "4")]
        [InlineData("-2", 31, Constant.NegativeMaxIntPlus1)]
        [InlineData("-2.5", 2, "6.25")]
        [InlineData("-2.5", 3, "-15.625")]
        [InlineData("-2.5", 4, "39.0625")]
        // -base, -exponent = - if exponent is odd, else +
